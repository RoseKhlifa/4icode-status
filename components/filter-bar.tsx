...
export function FilterBar(props: FilterBarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-2xl border border-border/50 bg-white/40 px-3 py-2.5 backdrop-blur dark:bg-white/[0.04] sm:gap-2.5 sm:px-4 sm:py-3">
      {/* 左: 漏斗图标 + 下拉, 手机隐藏漏斗省空间 */}
